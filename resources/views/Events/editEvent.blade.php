<x-layout>
    ...
    <section class="container-fluid h-100 mt-5 main-bg">
        <style scoped>
            [x-cloak] {
display: none;
}
...
<div class="editflex flex w-full justify-center">
<form class="relative bg-white p-4 w-9/12 rounded-lg shadow dark:bg-gray-700"  method="POST" action="/events/{{$eventings->id}}" enctype="multipart/form-data" autocomplete="off">
    @csrf
    @method('PUT')
    <div class="text-center text-lg">
        <h4 class="mt-1 mb-5 pb-1 text-white">Edit Form, Boss!</h4>
    </div>
    <div class="flex flex-wrap w-full flex-row justify-center items-center">
        ...
        <div class="mb-6 w-2/5 m-2">
            ...
            {{-- <input type="artist_Name" name="artist_Name" value="{{$eventings->artist_Name}}" id="artist_Name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" > --}}
            <select id="artist_Name" name="artist_Name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option value="{{$eventings->artist_Name}}" selected>{{$eventings->artist_Name}}</option>
        ...
        <div class="mb-6 w-2/5 m-2">
            <label for="gerne" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Genres (<span class="text-gray-500">{{$eventings->gerne}}</span>)</label>
            {{-- <input type="text" name="gerne" value="{{$eventings->gerne}}" id="gerne" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" > --}}
            {{-- st --}}
        ...
        <div class="mb-6 w-2/5 m-2">
            ...
            <input type="text" id="shortDesc" name="shortDesc" value="{{$eventings->shortDesc}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Short Description" >
            @error('shortDesc')
            <p class="text-red-600 text-xs mt-1">{{$message}}</p>
        @enderror
        </div>
        <div class="mb-6 w-2/5 m-2">
            ...
            <input type="number" id="amount" placeholder="Amount" name="amount" value="{{$eventings->amount}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
            @error('amount')
            <p class="text-red-600 text-xs mt-1">{{$message}}</p>
    @enderror
        </div>
        ...
        <div class="mb-6 w-2/5 m-2">
            ...
            <input type="date" name="date" value="{{$eventings->date}}" id="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" >
            @error('date')
            <p class="text-red-600 text-xs mt-1">{{$message}}</p>
        @enderror
        </div>
        <div class="mb-6 w-2/5 m-2">
            ...
            {{-- <input type="text" name="venue" value="{{$eventings->venue}}" id="venue" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" > --}}
            <select id="venue" name="venue" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option value="{{$eventings->venue}}" selected>{{$eventings->venue}}</option>
    ...
    @enderror
        ...
        <div class="mb-6 w-2/5 m-2">
            ...
            <img class="rounded" style="margin-top:10px;" src="{{asset('storage/' . $eventings->image)}}" alt="">
        @error('image')
        ...
        <div class="mb-6 w-2/5 m-2">
            ...
            <div class="flex items-center justify-center w-full">
                <label for="image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    ...
                    <input id="image" name="image" value="{{$eventings->image}}" type="file" class="hidden" />
                </label>
            </div> 
        </div>
    </div>
